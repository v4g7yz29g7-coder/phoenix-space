// architect/router_v5.js — Девятиосевой DAS
...
function route(text, opts = {}) {
  ...
  return {
    ...
    autonomy: au.autonomy, autonomySource: au.source,
  };
}
...
if (require.main === module) {
  ...
  for (const t of cases) {
    const r = route(t);
    console.log(`[${r.mode.padEnd(11)}|${r.dna.padEnd(5)}|${r.lang.padEnd(4)}|${r.length.padEnd(6)}|${r.iter.padEnd(9)}|${r.verify.padEnd(7)}|${r.creativity.padEnd(12)}|${r.team.padEnd(4)}|${r.autonomy.padEnd(7)}] ${t.slice(0, 38)}`);
  }
}
